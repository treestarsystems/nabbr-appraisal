...
// import AppraisalBodyChartComponent from '../components/AppraisalBodyChartComponent.vue';
import { ref, inject, toRaw, onMounted } from 'vue';
import { useRoute } from 'vue-router';
import { useAuthStore } from '../stores/authStore';
import {
  getAppraisalChartHelper,
  generateRadioIdsHelper,
  calculateTotalHelper,
  allRadiosFilledHelper,
  updateTotalScoreHelper,
} from '../helpers/chartHelper';
import { Chart } from '../types/chartTypes';
import { UserState } from '../types/authTypes';
import { SwalToastErrorHelper } from '../helpers/sweetalertHelper';

const totalScoreRef = ref(0);
            ...
            <tr>
              ...
              <td class="align-middle p-10">
                <div class="col-sm-12 col-12">
                  <div class="row">
                    ...
                    <div class="col-sm-4 d-flex justify-content-center">
                      <label :for="`${generateRadioIdsHelper(division.name, characteristic[0].name, 'zero')}`">0</label>
                    </div>
                    <div class="col-sm-4 d-flex justify-content-center">
                      <label :for="`${generateRadioIdsHelper(division.name, characteristic[0].name, 'plus')}`">+</label>
                    </div>
                  </div>
              ...
              <td class="align-middle">
                <div class="col-sm-12 col-12">
                  <div class="row">
                    ...
                    <div class="col-sm-4 d-flex justify-content-center">
                      <label :for="`${generateRadioIdsHelper(division.name, characteristic[1].name, 'zero')}`">0</label>
                    </div>
                    <div class="col-sm-4 d-flex justify-content-center">
                      <label :for="`${generateRadioIdsHelper(division.name, characteristic[1].name, 'plus')}`">+</label>
                    </div>
                  </div>
                  <div class="row was-validated">
                    <div class="col-sm-4 d-flex justify-content-center">
              ...
              <td class="align-middle">
                <div class="col-sm-12 col-12">
                  <div class="row">
                    ...
                    <div class="col-sm-4 d-flex justify-content-center">
                      <label :for="`${generateRadioIdsHelper(division.name, characteristic[2].name, 'zero')}`">0</label>
                    </div>
                    <div class="col-sm-4 d-flex justify-content-center">
                      <label :for="`${generateRadioIdsHelper(division.name, characteristic[2].name, 'plus')}`">+</label>
                    </div>
                  </div>
                  <div class="row was-validated">
                    <div class="col-sm-4 d-flex justify-content-center">
              ...
              <td class="align-middle">
                <div class="d-flex justify-content-center">
                  <span v-if="allRadiosFilledHelper(characteristic)" class="badge border border-white text-white">{{
                    calculateTotalHelper(division.characteristics[ci])
                  }}</span>
                  <span v-else></span>
                </div>
              </td>
              ...
              <td class="align-middle">
                <div class="d-flex justify-content-center">
                  <span v-if="allRadiosFilledHelper(characteristic)" class="badge border border-success text-success">{{
                    ((calculateTotalHelper(division.characteristics[ci]) + characteristic[0].factor) *
