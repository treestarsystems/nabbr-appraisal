...
<template>
              ...
              <tr>
                ...
                <td class="align-middle">
                  <div class="d-flex justify-content-center">
                    <span class="badge border border-info text-info">7</span>
                  </div>
                </td>
                <td class="align-middle"></td>
                <td class="align-middle">
                  <div class="d-flex justify-content-center">
                    <span class="badge border border-info text-info">4</span>
                  </div>
                </td>
                <td class="align-middle">
                  <div class="d-flex justify-content-center">
                    <span class="badge border border-success text-success">%</span>
                  </div>
                </td>
              </tr>
            </tbody>
  ...
  <div class="row gx3">
    ...
    <div class="col-sm-2 col-2">
      <!-- Form field start -->
      <div class="mb-3">
        <label for="appraisalTotalScore" class="form-label">Total:</label>
